...
<h2>Overview</h2>
<p>Dictionary Binary Search Tree used for a spell checking CMake console application. I will show the header file first, then the definition class file.</p>
